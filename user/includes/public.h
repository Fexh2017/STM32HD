...
u32 sys_timer_add(void (*fun)(void* arg), void* arg, u32 ms);	//新增系统定时器事件
u32 sys_timer_del(u32 id);										//删除系统定时器事件
void sys_timer_loop(void);										//系统定时器
u32 sys_get_tick(void);											//系统计时（72M）
